...
cat_vars <- names(train.data.2)[sapply(train.data.2, is.factor)]
cat_vars <- setdiff(cat_vars, "income")  # exclude target
...
train.data.2 <- dummy_cols(                                        # --> might change
  train.data.2,
...
# dummy encode all categorical variables                              --> might change
