...
# force all categorical variables in test.data.1 to match train.data.1 levels
factor_vars <- names(train.data.1)[sapply(train.data.1, is.factor)]
for (var in factor_vars) {
  test.data.1[[var]] <- factor(test.data.1[[var]], levels = levels(train.data.1[[var]]))
}
