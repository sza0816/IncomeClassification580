...
```{r}
Q1 <- quantile(na.omit(train.data$hours_per_week), 0.25)
Q3 <- quantile(na.omit(train.data$hours_per_week), 0.75)
IQR <- Q3 - Q1

lower <- Q1 - 1.5 * IQR
upper <- Q3 + 1.5 * IQR

outliers_hw <- train.data[train.data$hours_per_week < lower | train.data$hours_per_week > upper, ]
```
