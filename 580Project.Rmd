...
```{r}
# read test data
test.data <-read.csv("~/Desktop/IncomeClassification580/train.csv", 
                     header = T, 
                     na.strings = " ?")
...
IQR method to remove outliers for column hours.per.week
...
``` {r}
# Find the best paramater for size and decay
